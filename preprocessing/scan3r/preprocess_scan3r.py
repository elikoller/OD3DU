...
def process_scan(data_dir, rel_data, obj_data, cfg, rel2idx, rel_transforms = None):
    ...
    #the pointclouds are stored in the coordinate system of the reference frame
    data_dict['obj_points'] = object_points #the pointcloud in different resoltuions: "64 to 512
