...
class Evaluator():
    def __init__(self, cfg, split):
        ...
        self.out_dir = osp.join(self.data_root_dir, "Results_lowdim" )
    ...
    def compute(self, mode):
        ...
        for scan_id in tqdm(self.scan_ids):
            ...
            reference_info_path = osp.join("/media/ekoller/T7/Features2D_lowdim/projection", self.model_name, "patch_{}_{}".format(self.image_patch_w,self.image_patch_h),"{}.pkl".format(reference_id))
            ...
            scan_info_path = osp.join("/media/ekoller/T7/Features2D_lowdim/dino_segmentation", self.model_name, "patch_{}_{}".format(self.image_patch_w,self.image_patch_h),"{}.pkl".format(scan_id))
            with open(scan_info_path, 'rb') as file:
                scan_data = pickle.load(file)

            #access the segmentation of the scan_id
            segmentation_info_path = osp.join("/media/ekoller/T7/files/Segmentation/DinoV2/objects", scan_id + ".pkl")
